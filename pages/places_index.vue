...
<template>
  <div class="container">
   <HeaderView />
   <h3 style="margin-top: 15px">Places </h3>
   <p id=parra>This category lists places. </p>
   <ul class="ul">
     <li v-for="p of places" :key="p.slug">
       <div class="card">
          <div>
            <img class="card-img" :src="'/images/lugares/' + p.image" />
          </div>
          <div class="card-text">
            ...
            <NuxtLink :to="{ name: 'places-slug', params: { slug: p.slug } }" class="button">
                Details
            </NuxtLink>
          </div>
        </div>
